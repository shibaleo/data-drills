...
import { project as projectTable, problem, problemFile, oauthToken, subject, level } from "@/lib/db/schema";
import { eq, inArray } from "drizzle-orm";
import { getDriveClient } from "@/lib/google-oauth";
import { listFolderPdfs, downloadDriveFile } from "@/lib/drive-helpers";
import {
  parsePdfFilename,
  classifyPages,
  problemPageIndices,
